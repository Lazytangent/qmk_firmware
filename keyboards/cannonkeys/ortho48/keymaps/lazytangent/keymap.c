...
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    KC_ESC,  KC_LALT, KC_LGUI, MO(3),   MO(1), KC_SPC, KC_ENT,  MO(2), KC_BSPC, KC_DEL,  KC_UP,   KC_ENT
),
...
[_LOWER] = LAYOUT_ortho_4x12(
    ...
    _______, _______, A(KC_F4), G(KC_D), _______, _______, _______, MO(4), KC_HOME, KC_PGDN, KC_PGUP, KC_END
),

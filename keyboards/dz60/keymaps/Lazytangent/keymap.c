...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    [_1] = LAYOUT_Lazy1(
      ...
      ______, ______, ______,                           ______,                          MO(5),  ______, MO(4),  ______, ______
    ),
   ...
   * |-----------------------------------------------------------------------------------------+
   * |      |Alt(F4)| Gui(D)|                                   |      |MO(5)|Left |Down |Right|
   * `-----------------------------------------------------------------------------------------'
   */
    ...
    [_3] = LAYOUT_Lazy1(
        ...
        ______,  A(KC_F4), G(KC_D),                            ______,                             ______,  MO(5),   KC_LEFT, KC_DOWN, KC_RGHT
    ),

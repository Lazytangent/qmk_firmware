...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------------------------------------+
   * | Ctl | Alt | Gui |   MO(1)   | Space |    Backspace    | MO(3) | MO(4) |  L  |  D  |  R  |
   * `-----------------------------------------------------------------------------------------'
   */
  ...
  */
   ...
   */
    ...
    [_1] = LAYOUT_Lazy1(
      ...
      _______, _______, _______, _______, KC_LPRN, KC_RPRN, KC_UNDS, KC_MINS, KC_EQL,   KC_PLUS, KC_COLN, KC_DQUO, _______,
      _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_LT,   KC_GT,   KC_QUES, KC_INS,  KC_PGUP, _______,
      _______, _______, _______,          _______,          MO(_3),           KC_LSFT,          _______, _______, KC_HOME, KC_PGDN, KC_END
    ),

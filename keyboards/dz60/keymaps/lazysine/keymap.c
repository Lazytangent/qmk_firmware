...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    [_QWERTY] = LAYOUT_Lazy1(
      ...
      KC_CAPS, KC_LALT,       KC_LGUI,         MO(_1),         KC_SPC,        MO(_2),           MO(_3),  _______, KC_LEFT,       KC_DOWN, KC_RIGHT
    ),
  /* 1
   * ,-----------------------------------------------------------------------------------------.
   * |  `  |  !  |  @  |  #  |  $  |  %  |  ^  |  &  |  *  |  (   |  )  |  _  |  +  |  RESET   |
   ...
   */
    ...
    [_3] = LAYOUT_Lazy1(
        ...
        _______, A(KC_F4), G(KC_D),          _______,          _______,          _______,          _______, _______, KC_LEFT, KC_DOWN, KC_RGHT
    ),
};

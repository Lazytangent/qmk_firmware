...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ansi_69(
        ...
        KC_LCTL, KC_LOPT,  KC_LCMD,           MO(2),            KC_SPC,   MO(3),            MO(3),             KC_RCMD,            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [1] = LAYOUT_ansi_69(
        ...
        KC_LCTL, KC_A,     KC_S,     KC_D,    KC_F,    KC_G,              KC_H,    KC_J,    KC_K,    KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,           KC_HOME,
        KC_LSFT,           KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,     KC_B,    KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, KC_UP,
        KC_LCTL, KC_LWIN,  KC_LALT,           MO(2),            KC_SPC,   MO(3),            MO(3),             KC_RALT,            KC_LEFT, KC_DOWN, KC_RGHT
    ),

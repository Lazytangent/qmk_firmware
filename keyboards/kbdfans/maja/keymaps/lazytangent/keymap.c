...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[0] = LAYOUT( /* Base */
		  ...
		  KC_LALT,           KC_LGUI,  MO(1),        KC_SPC,         MO(2),           KC_RCTL,                      KC_LEFT, KC_DOWN,   KC_RIGHT
		),
		[1] = LAYOUT( /* FN */
			KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS, KC_PLUS, KC_BSPC,  KC_HOME,
		  KC_TRNS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, KC_PAUS, RESET,    KC_PGUP,

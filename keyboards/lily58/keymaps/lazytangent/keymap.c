...
[_LOWER] = LAYOUT( \
  ...
  KC_CAPS, _______, _______, KC_ENT,  KC_LPRN, KC_RPRN,                   KC_UNDS, KC_MINS, KC_EQL,  KC_PLUS, KC_COLN,  _______, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,  _______, _______,  _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, \
                             _______, _______, ADJUST,   _______, _______,  _______, _______, FLAYER \
),
/* ADJUST + NUMPAD
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |  7   |  8   |  9   |  *   |      |
 ...
 */
[_ADJUST] = LAYOUT( \
_______, _______, _______, _______, _______, _______,                   _______, KC_P7,   KC_P8,   KC_P9,   KC_PAST, KC_BSPC, \

...
[_LOWER] = LAYOUT( \
  ...
  _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, \
                             _______, _______, _______, _______, _______, MO(3),   KC_DEL,  MO(5) \
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |  ~   |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, _______, KC_DEL,  KC_END,  KC_PGDN,  _______, _______,  _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, \
